...
@Component
@Slf4j
public class ArgumentEnhanceOpenAiStep implements IPipelineStep<ArgumentEnhanceRequest,ArgumentEnhanceRequest>{

    OpenAiService service;
    String prompt;

    public ArgumentEnhanceOpenAiStep(OpenAiService service, @Qualifier("argument-adding prompt") String prompt){
    ...
    public ArgumentEnhanceRequest execute(ArgumentEnhanceRequest request){
        ...
        log.info("argument-adding prompt");
